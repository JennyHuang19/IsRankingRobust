...
def isRankingRobust(k, alphaN, X, y, method = "IF", weighted = False):
    ...
    return -1, -1, -1, -1, [-1] # return all-negative 1's when ranking is robust.
...
class LogisticAMIP():
    ...
    def AMIP_sign_change(self, alphaN, dim_1, dim_2 = None, 
                    method = "1sN", refit = True): # adjust this function to sum the influence scores.
        '''
